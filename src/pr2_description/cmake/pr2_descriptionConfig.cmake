...
if("FALSE" STREQUAL "TRUE")
  set(pr2_description_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-pr2-description-1.12.0)
  set(pr2_description_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-pr2-description-1.12.0/obj-x86_64-linux-gnu/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
